...
class ModelCodeGenerator:
    ...
    def _generate_model_class(self, table: TableState) -> tuple[str, set[str]]:
        ...
        if table.view_query:
            config_parts.append(f"view_query={table.view_query!r}")

        if table.relation_in:
            config_parts.append(f"relation_in={table.relation_in!r}")

        if table.relation_out:
            config_parts.append(f"relation_out={table.relation_out!r}")
